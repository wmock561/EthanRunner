...
pygame.display.set_caption("Chrome Ethan Runner")

Ico = pygame.image.load("assets/DinoWallpaper.png")
pygame.display.set_icon(Ico)

RUNNING = [
    pygame.image.load(os.path.join("assets/Ethan", "EthanRun1.png")),
    pygame.image.load(os.path.join("assets/Ethan", "EthanRun2.png")),
]
JUMPING = pygame.image.load(os.path.join("assets/Ethan", "EthanJump.png"))
DUCKING = [
    pygame.image.load(os.path.join("assets/Ethan", "EthanDuck1.png")),
    pygame.image.load(os.path.join("assets/Ethan", "EthanDuck2.png")),
]
